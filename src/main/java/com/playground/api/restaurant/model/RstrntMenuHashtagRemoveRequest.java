...
@Schema(name = "RstrntMenuHashtagRemoveRequest", description = "메뉴 해시태그 삭제 요청 데이터")
@EqualsAndHashCode(callSuper = true)
@Getter
public class RstrntMenuHashtagRemoveRequest extends BaseDto {
  ...
  @NotNull(message = "해시태그일련번호는 필수 값 입니다.")
  @Schema(description = "해시태그일련번호", requiredMode = RequiredMode.REQUIRED)
